...
+ (NSInteger)numberOfDays:(NSDate *)date1 reduce:(NSDate *)date2 {
    date1 = [NSString stringWithFormat:@"%@ 00:00:00", [date1 shortTimeString]].dateTypeValue;
    date2 = [NSString stringWithFormat:@"%@ 00:00:00", [date2 shortTimeString]].dateTypeValue;

    NSInteger   nSecs = (NSInteger)(date1.timeIntervalSince1970 - date2.timeIntervalSince1970);
