...
- (void)calculateSize {
    if (self.isMenuInTop) {
        viewHeight = APP_HEIGHT - 20 - self.tabBarController.tabBar.height - self.navigationController.navigationBar.height;
    } else {
        viewHeight = APP_HEIGHT - 20 - self.menuHeight - self.tabBarController.tabBar.height - self.navigationController.navigationBar.height;
    }
