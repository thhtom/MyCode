...
@implementation UILabel (GJLabel)
...
@implementation UIButton (GJButton)
...
@implementation UIImageView (GJImageView)
...
@implementation UITableView (GJTableView)
...
@implementation UITableViewCell (GJTableViewCell)
...
@implementation UIWebView (GJWebView)
...
@implementation UISearchBar (GJSearchBar)
